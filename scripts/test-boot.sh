...
grep -Fq "Boulder: Black Lab time=600 ns, heat=11000, predictions=1, epoch=2, generation=2, faults=1, artifact=64 bytes, PID1 plan entry=0x1000, install=dry-run:1" "$output"
