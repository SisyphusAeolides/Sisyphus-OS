...
grep -Fq "Boulder: Ring 3 trap rip=0x1001 cs=0x1b, returning through RSP0" "$output"
grep -Fq "frames=6, retained=true, cr3_activation=validated, ring3_probe=returned" "$output"
