...
impl ManifoldWindow {
    ...
    pub fn attract_to(&mut self, other: &ManifoldWindow, k: f64, rest: f64) {
        ...
        let acc_u = fu - gam[0][0][0]*fu*du - gam[0][0][1]*fu*dv
                       - gam[0][1][0]*fv*du - gam[0][1][1]*fv*dv;
        let acc_v = fv - gam[1][0][0]*fu*du - gam[1][0][1]*fu*dv
                       - gam[1][1][0]*fv*du - gam[1][1][1]*fv*dv;
    ...
    pub fn step(&mut self) {
        ...
        let delta_u = -(gam[0][0][0]*v[0]*v[0] + 2.0*gam[0][0][1]*v[0]*v[1]
                       + gam[0][1][1]*v[1]*v[1]) * 0.016;
        let delta_v = -(gam[1][0][0]*v[0]*v[0] + 2.0*gam[1][0][1]*v[0]*v[1]
                       + gam[1][1][1]*v[1]*v[1]) * 0.016;
    ...
    pub fn set_spherical(&mut self, radius: f64) {
        ...
        self.metric = [[radius*radius, 0.0], [0.0, radius*radius * sin_t*sin_t]];
...
impl ManifoldScene {
    pub fn new(curvature: f64) -> Self {
        Self { windows: Vec::new(), global_curvature: curvature }
    }
